  ...
  <span :class="imageViewClass">
    ...
    >
      <div
        ...
        :width="width"
        :height="height"
        class="image-view__body__image iframe-container"
        :style="'width:'+width+'px;height:'+height+'px'"
        @click="selectImage"
      >
        <iframe
          @dbclick="toggleShowReizeIframe"
          :src="src"
          :width="width"
          :height="height"
          frameborder="0"
          style="width: 100%;height:100%;min-width:100%;min-height:100%;pointer-events:none;"
        ></iframe>
      </div>
      ...
      >
        <image-bubble-menu :node="node" :view="view" :update-attrs="updateAttrs" />
...
import ImageBubbleMenu from '../MenuBubble/IframeBubbleMenu.vue';
