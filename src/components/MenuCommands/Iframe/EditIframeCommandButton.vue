<template>
  <div>
    <command-button
      ...
      :tooltip="t('editor.extensions.NewIframe.buttons.page_options.tooltip')"
      icon="ellipsis-h"
    />

    <el-dialog
      :title="t('editor.extensions.NewIframe.control.edit_page.title')"
    ...
    >
      <el-form
        ...
        size="small"
      >
        <el-form-item :label="t('editor.extensions.NewIframe.control.edit_page.form.src')">
          <el-input
        ...
        <el-form-item :label="t('editor.extensions.NewIframe.control.edit_page.form.alt')">
          <el-input
        ...
        <el-form-item>
          <el-col :span="11">
            <el-form-item :label="t('editor.extensions.NewIframe.control.edit_page.form.width')">
              <el-input
          ...
          <el-col
            ...
            :push="2"
          >
            <el-form-item :label="t('editor.extensions.NewIframe.control.edit_page.form.height')">
              <el-input
      ...
      <template #footer>
        ...
        >
          {{ t('editor.extensions.NewIframe.control.edit_page.cancel') }}
        </el-button>
        ...
        >
          {{ t('editor.extensions.NewIframe.control.edit_page.confirm') }}
        </el-button>
      </template>
    </el-dialog>
  </div>
...
export default class EditIframeCommandButton extends Mixins(i18nMixin) {
  @Prop({
